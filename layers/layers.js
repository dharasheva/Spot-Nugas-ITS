...
lyr_TitikLokasi_1.set('fieldLabels', {'Nama Tempat': 'header label - always visible', 'Tingkat Kenyamanan': 'header label - always visible', 'Tingkat Kebisingan': 'header label - always visible', 'Tingkat Kebersihan': 'header label - always visible', 'Kapasitas': 'header label - always visible', 'Kepadatan Pengunjung': 'header label - always visible', 'session': 'hidden field', 'session_id': 'hidden field', 'language': 'hidden field', 'validation_status': 'hidden field', });
